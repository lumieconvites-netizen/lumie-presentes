        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-[#e3d2c6] bg-gradient-to-br from-white to-[#fff8f3] p-7 shadow-sm">
              ...
              <p className="text-[#5f534e] text-lg mb-3">🚫 Sem arcar com custos de operação.</p>
              <p className="text-[#5f534e] text-lg">🚫 Sem equipe, suporte ou dor de cabeça.</p>
            </div>

            <div className="rounded-2xl border border-[#e3d2c6] bg-white p-7 shadow-sm">
              <h3 className="font-display text-2xl text-[#2b2422] mb-4">Parceria elegante e estratégica 🌸</h3>
              <p className="text-[#61554f] mb-3">Seus clientes recebem uma experiência digital sofisticada, moderna e encantadora.</p>
              <p className="text-[#61554f] mb-3">Você agrega mais valor ao seu serviço e aumenta sua autoridade no mercado.</p>
              <p className="text-[#61554f]">E ainda cria uma renda recorrente proporcional ao sucesso dos eventos que já organiza.</p>
            </div>
          </div>
        </div>
      </section>
